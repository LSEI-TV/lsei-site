...
- [lsei-new-site](lsei-new-site.md) — refonte lsei.tv (5 disciplines), dev dans `D:\LSEI - NEW SITE`
- [lsei-vocabulaire](lsei-vocabulaire.md) — mots créés par LSEI à conserver tels quels (« webtvspectateur(s) »)
- [lsei-ux-une-page](lsei-ux-une-page.md) — minimiser les changements de page (accordéon/inline) ; page saison supprimée, ne pas recréer
- [billard-femmes](billard-femmes.md) — 2e compétition billard (Blackball Femmes) sous `/femmes`, parallèle aux Masters
- [billard-newcomers-mixte](billard-newcomers-mixte.md) — section « Les nouveaux accédants » + provenance Mixte National (feeder N→N+1, ajout de liens)
